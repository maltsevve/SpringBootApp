...
@Api(tags = { "Files: administrator access" })
public class AdminFileRestControllerV1 {
    ...
    public ResponseEntity<AdminFileDto> saveFile(@RequestHeader(value = "Authorization") String token,
        ...
        if (Objects.isNull(file) | Objects.isNull(token)) {
...
//        java.io.File fileFromS3Bucket = amazonClient.downloadFile(file.getFileName());
